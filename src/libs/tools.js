 ...
 */
// 增加if判断是因为有些浏览器对document.addEventListener不兼容
//ie仅仅支持attachEvent,而FF和Chrome仅仅支持addEventListener
// 所以就必须为这两个方法做兼容处理，原理是先推断addEventListener为真（存在）
// 假设为真则用addEventListener方法。否则的话就用attachEvent（）。
